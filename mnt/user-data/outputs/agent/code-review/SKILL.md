...
name: code-review
description: >
  Review code for correctness, security, tests, readability, and performance. Use when reviewing your own or someone else's code, doing a PR review, or auditing for bugs and issues. Triggered by: review this code, check my code, PR review, find bugs, self-review, code audit.
---
...
- Use your version control diff view when reviewing changes before committing.
- For AI-assisted reviews: paste the code and this checklist into your AI assistant with "Review this code
  against the checklist below."
- When reviewing AI agent output: always review generated code before running or committing —
