...
name: plan
description: >
  Break a spec into a sequenced task plan with estimates and dependencies. Use when planning work, creating task breakdowns, writing tickets, or prioritizing what to build next. Triggered by: plan this, break into tasks, create tickets, estimate, what order should I build.
---
...
- In your IDE, the AI agent works best with small, focused tasks — prefer S and M sizes.
- When using AI agent, paste individual TASK descriptions as prompts for best results.
- Use inline code comments and TODO markers to track in-progress tasks.
