...
|---|---|---|
| "I want to build X" / "New feature: X" | SPEC | `references/spec.md` |
| "Here's my spec, what next?" | PLAN | `references/plan.md` |
| "Help me plan / break this down" | PLAN | `references/plan.md` |
| "Write tests first" / "TDD this" | TDD | `references/tdd.md` |
| "Implement this" / "Write the code" | BUILD | `references/build.md` |
| "Review this code" / "Check my PR" | REVIEW | `references/review.md` |
| "Write integration/E2E tests" | TEST | `references/test.md` |
| Ambiguous — e.g. "Help me with X" | SPEC | `references/spec.md` |
...
*Full details: `references/spec.md`*
...
*Full details: `references/plan.md`*
...
*Full details: `references/tdd.md`*
...
*Full details: `references/review.md`*
...
*Full details: `references/test.md`*
...
**Replit**: Store specs/plans in `/docs/`. Use Shell for tests/git. Use Secrets for env vars.
...
**Starting fresh**: Say "I want to build [X]" → load `references/spec.md` → work through each phase in order.
...
**AI agent delegation** (Replit Agent): After PLAN, each task description becomes a prompt. After TDD, "make these failing tests pass" is your build prompt.
