...
name: build
description: >
  Guide the actual implementation and coding of software features, from setting up a project
  to writing production-ready code. Use this skill whenever an engineer is about to write code,
  set up a new project or module, implement a feature from a spec or plan, scaffold a codebase,
  structure files and folders, write a function or class, or needs guidance on how to approach
  building something. Trigger when the user says "help me build this", "implement this feature",
  "set up the project", "scaffold this", "write the code for", "how should I structure this",
  or "start coding". Always use after spec and plan are complete.
---
