...
name: spec
description: >
  Write software specification documents for any feature, system, or project. Use this skill
  whenever an engineer asks to write a spec, define requirements, document a feature, create
  a PRD (Product Requirements Document), write a technical design document, capture acceptance
  criteria, or describe what software should do before building it. Trigger even when the
  user says things like "help me think through this feature", "document what we're building",
  "write up the requirements", or "I need to spec this out". Always use this skill before
  building — a spec is the foundation of good software.
---
...
- Use Replit's file tree to keep specs co-located with the code they describe.
- Link spec files in your Replit README so the AI agent has context when building.
